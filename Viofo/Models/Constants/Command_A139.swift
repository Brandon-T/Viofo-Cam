...
class Command_A139: Command {
    ...
    class var FIRMWARE_A139: String { "VIOFO_A139" }
    class var FIRMWARE_A139_JP: String { "VIOFO_A139_JP_" }
    ...
    override class var REAR_CAMERA_MIRROR: Int { 9220 }
    override class var REAR_IMAGE_ROTATE: Int { 8226 }
